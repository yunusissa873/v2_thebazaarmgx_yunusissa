...
import { useVendor } from '@thebazaar/hooks/useMockData';
import { useSupabaseProduct } from '@thebazaar/hooks/useSupabaseProducts';
import { useSupabaseProductReviews, useSupabaseReviewStats } from '@thebazaar/hooks/useSupabaseReviews';
...
import { incrementProductView } from '@thebazaar/supabase/products';
