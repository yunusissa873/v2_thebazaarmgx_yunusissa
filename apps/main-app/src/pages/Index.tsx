...
import { useFeaturedCategories, useVendors, useProducts as useMockProducts } from '@thebazaar/hooks/useMockData';
import { useSupabaseProducts, useSupabaseFeaturedProducts } from '@thebazaar/hooks/useSupabaseProducts';
